...
from optim_algorithms import LeastSquares
...
def main():
    ...
    fval_sgd, iter_sgd = LeastSquares.stochastic_gradient_descent(A, b, x_init, 0.1, f_val_init, criterion='gradient_norm', max_iter=100)
