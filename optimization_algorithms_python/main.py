...
def main():
    ...
    print("Solution via Newton method")
    (fval_newton, iter_newton) = QuadraticUncon.newton_method(P, q, x, 1, f_val_init, criterion='gradient_norm', max_iter=100)
